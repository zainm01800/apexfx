...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const resources = [
    'index.html', 'dashboard.html', 'history.html', 'backtest.html', 'track-record.html', 'how-it-works.html', 'engine-book.html',
    'dashboard.css', 'history.css', 'backtest.css',
    'dashboard.js', 'history.js', 'backtest.js', 'track-record.js', 'engine-book.js'
  ];
