...
export function summarize(payload, book) {
  ...
  const expected = (book === 'v24' || book === 'v30') ? 'higher_5_12_static' : (book === 'v6' ? 'strict_3_6_static' : 'standard_5_10_static');
...
export function tradeCard(t, kind = 'positions') {
  ...
  const exitLabel = exitDate ? dateLabel(exitDate) : (t.instrument === 'SPY' && !exitDate) ? 'Intraday · 15:59 NY flat' : 'After 5 completed sessions';
