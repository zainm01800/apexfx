"""Test Volatility-Targeted Dual Momentum at 1.0% Risk per Trade.

Compares 0.75% Risk (5.5% Target Vol) vs 1.00% Risk (7.3% Target Vol) on 1 Single £100k Account.
"""
...
def run_1pct_comparison():
    ...
    print("=" * 70)
    print("DUAL MOMENTUM: 0.75% RISK VS 1.00% RISK ON 1 SINGLE £100K ACCOUNT")
    print("=" * 70)
    
    for rpt, target_vol in [(0.0075, 0.055), (0.0100, 0.0733)]:
        ...
        print(f"\nRisk per Trade: {rpt*100:.2f}% (Target Vol: {target_vol*100:.1f}%):")
